...
public class MessageBundle {
    ...
    public static final String MISSING_OR_INVALID_COLOR_RESPONSE = "Missing or invalid color. Colors are only accepted from the pre-defined list";
    ...
    public static final String MISSING_OR_INVALID_RECURRING_TYPE_ERROR_MESSAGE = "Missing or invalid recurring type. Recurring type must be a value from the pre-defined list";
