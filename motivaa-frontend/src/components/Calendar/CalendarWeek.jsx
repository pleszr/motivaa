export default function CalendarWeek({ score }) {
    // logic to dynamically set up week numbers and periods
    return (
        <div className="w-full flex flex-col gap-4 p-8 bg-white cursor-pointer rounded-2xl shadow-motivaa-shadow hover:scale-[1.01] transition-all duation-200">
