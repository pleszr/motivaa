export default function WeekdayCheckbox({ weekday }) {
    ...
    return (
        <button className="relative group w-12 h-12 bg-gray flex justify-center items-center border-2 border-transparent rounded-full hover:border-purple transition-all duration-200">
